...
class Person {
    ...
    //private LocalDate marriage;
    //private LocalDate divorce;
    //private List<Tuple<Person, LocalDate, LocalDate>> maritalStatus;
    ...
    public void Dead(LocalDate deadData) { this.deadData = deadData; }

    public void Marriadge(Person spouse, LocalDate marriageDate ){
        maritalStatus.add(new MaritalStatus(spouse, marriageDate));
    }
    public void Divorce(Person spouse, LocalDate divorceDate){
